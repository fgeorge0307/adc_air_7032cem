  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: black">
    ...
    <a href="" class="brand-link">
      <img src="{{asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">ABC Air</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('e_dashboard') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('airframes') }}" class="nav-link">
              <i class="nav-icon fas fa-plane"></i>
              <p>
                View Airframes
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('record_flight') }}" class="nav-link">
              <i class="nav-icon fas fa-plane"></i>
              <p>
                Add Flight Record
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('record_maintenance') }}" class="nav-link">
